class GRUModel {
    ...
    buildModel() {
        // Build a deeper GRU-based model. The additional layers and
        // increased number of units enable the network to capture more
        // complex temporal patterns and cross-stock interactions. A
        // dense layer with ReLU activation prior to the output further
        // enhances representational capacity. Dropout is used to reduce
        // overfitting. The final layer remains a sigmoid activation for
        // multi-label binary classification (30 outputs).
        ...
        // Compile the model. We continue to use the Adam optimizer with a
        // conservative learning rate. Binary crossentropy is appropriate for
        // multiple independent binary outputs and we monitor binary accuracy.
        this.model.compile({
